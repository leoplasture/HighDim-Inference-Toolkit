...
class LassoCD:
    ...
    def fit(
        ...
        Args:
                ...
                lambda_param: L1 penalty strength (lambda >= 0).
        ...
        r = ys.copy()  # residual = y - X beta, initially beta=0
        z = (Xs**2).mean(axis=0)
        z[z == 0.0] = 1.0
        ...
        for _ in range(max_iter):
            ...
            for j in range(p):
                ...
                # beta_j <- S(rho_j, lambda) / z_j
                # where rho_j = (1/n) * x_j^T (y - sum_{k!=j} x_k beta_k)
                r_j = r + Xs[:, j] * beta[j]
